        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <button
              ...
              disabled={isLoading}
              className="px-6 py-4 rounded-xl font-bold text-white transition-all duration-300 transform hover:scale-105 hover:shadow-2xl disabled:opacity-50 flex flex-col items-center justify-center gap-3"
              style={{
            ...
            >
              ...
              <span className="text-sm text-center">{isLoading ? '🔄 Connecting...' : 'Google'}</span>
            </button>
            ...
            >
              ...
              <span className="text-sm text-center">{isLoading ? '🔄 Connecting...' : 'Facebook'}</span>
            </button>
